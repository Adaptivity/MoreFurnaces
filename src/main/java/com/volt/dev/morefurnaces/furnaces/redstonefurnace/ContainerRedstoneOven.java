...
public class ContainerRedstoneOven extends Container
{
    private TileEntityRedstoneOven tileFurnace;
    private int lastCookTime;
    private int lastBurnTime;
    private int lastItemBurnTime;
    private static final String __OBFID = "CL_00001748";

    public ContainerRedstoneOven(InventoryPlayer par1InventoryPlayer, TileEntityRedstoneOven par2TileEntityRedstoneOven)
    {
        this.tileFurnace = par2TileEntityRedstoneOven;
        this.addSlotToContainer(new Slot(par2TileEntityRedstoneOven, 0, 56, 17));
        this.addSlotToContainer(new Slot(par2TileEntityRedstoneOven, 1, 56, 53));
        this.addSlotToContainer(new SlotRedstoneOven(par1InventoryPlayer.player, par2TileEntityRedstoneOven, 2, 116, 35));
        int i;
    ...
    public ItemStack transferStackInSlot(EntityPlayer par1EntityPlayer, int par2)
    {
        ...
        if (slot != null && slot.getHasStack())
        {
            ...
            {
                if (RedstoneOvenRecipes.smelting().getSmeltingResult(itemstack1) != null)
                {
                ...
                else if (TileEntityRedstoneOven.isItemFuel(itemstack1))
                {
