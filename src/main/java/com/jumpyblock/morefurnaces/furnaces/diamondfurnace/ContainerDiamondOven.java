...
public class ContainerDiamondOven extends Container
{
    private TileEntityDiamondOven tileFurnace;
    private int lastCookTime;
    private int lastBurnTime;
    private int lastItemBurnTime;
    private static final String __OBFID = "CL_00001748";

    public ContainerDiamondOven(InventoryPlayer par1InventoryPlayer, TileEntityDiamondOven par2TileEntityGoldOven)
    {
        this.tileFurnace = par2TileEntityGoldOven;
        this.addSlotToContainer(new Slot(par2TileEntityGoldOven, 0, 56, 17));
        this.addSlotToContainer(new Slot(par2TileEntityGoldOven, 1, 56, 53));
        this.addSlotToContainer(new SlotDiamondOven(par1InventoryPlayer.player, par2TileEntityGoldOven, 2, 116, 35));
        int i;
    ...
    public ItemStack transferStackInSlot(EntityPlayer par1EntityPlayer, int par2)
    {
        ...
        if (slot != null && slot.getHasStack())
        {
            ...
            {
                if (DiamondOvenRecipes.smelting().getSmeltingResult(itemstack1) != null)
                {
                ...
                else if (TileEntityDiamondOven.isItemFuel(itemstack1))
                {
