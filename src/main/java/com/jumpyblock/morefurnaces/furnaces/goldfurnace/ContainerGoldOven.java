...
{
    private TileEntityGoldOven tileFurnace;
    ...
    public ContainerGoldOven(InventoryPlayer par1InventoryPlayer, TileEntityGoldOven par2TileEntityGoldOven)
    {
        ...
        this.addSlotToContainer(new SlotGoldOven(par1InventoryPlayer.player, par2TileEntityGoldOven, 2, 116, 35));
        int i;
    ...
    public ItemStack transferStackInSlot(EntityPlayer par1EntityPlayer, int par2)
    {
        ...
        if (slot != null && slot.getHasStack())
        {
            ...
            {
                if (GoldOvenRecipes.smelting().getSmeltingResult(itemstack1) != null)
                {
