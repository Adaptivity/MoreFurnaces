...
{
    private TileEntityBrickOven tileFurnace;
    ...
    {
        this.tileFurnace = par2TileEntityBrickOven;
        ...
        this.addSlotToContainer(new SlotBrickOven(par1InventoryPlayer.player, par2TileEntityBrickOven, 2, 116, 35));
        int i;
    ...
    public ItemStack transferStackInSlot(EntityPlayer par1EntityPlayer, int par2)
    {
        ...
        if (slot != null && slot.getHasStack())
        {
            ...
            {
                if (BrickOvenRecipes.smelting().getSmeltingResult(itemstack1) != null)
                {
