package com.jumpyblock.morefurnaces.furnaces.brickfurnace;
...
public class BrickOven extends BlockContainer
{
    ...
    public BrickOven(boolean p_i45407_1_)
    {
        super(Material.rock);
    ...
    {
        return Item.getItemFromBlock(MoreFurnaces.brickOven);
    }
    ...
    public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9)
    {
    	...
    	{
    		TileEntityBrickOven var10 = (TileEntityBrickOven) par1World.getTileEntity(par2, par3, par4);
    		if (var10 != null)
    		{
    			par5EntityPlayer.openGui(MoreFurnaces.instance, 3, par1World, par2, par3, par4);
    		}
    		return true;
    	}
    	else
    ...
    public static void updateFurnaceBlockState(boolean p_149931_0_, World p_149931_1_, int p_149931_2_, int p_149931_3_, int p_149931_4_)
    {
        ...
        if (p_149931_0_)
        {
            p_149931_1_.setBlock(p_149931_2_, p_149931_3_, p_149931_4_, MoreFurnaces.brickOvenActive);
        }
        else
        {
            p_149931_1_.setBlock(p_149931_2_, p_149931_3_, p_149931_4_, MoreFurnaces.brickOven);
        }
    ...
    public void onBlockPlacedBy(World p_149689_1_, int p_149689_2_, int p_149689_3_, int p_149689_4_, EntityLivingBase p_149689_5_, ItemStack p_149689_6_)
    {
        ...
        {
            ((TileEntityBrickOven)p_149689_1_.getTileEntity(p_149689_2_, p_149689_3_, p_149689_4_)).func_145951_a(p_149689_6_.getDisplayName());
        }
    }
    ...
    public void breakBlock(World p_149749_1_, int p_149749_2_, int p_149749_3_, int p_149749_4_, Block p_149749_5_, int p_149749_6_)
    {
        if (!field_149934_M)
        {
            TileEntityBrickOven tileentitybrickovenidle = (TileEntityBrickOven)p_149749_1_.getTileEntity(p_149749_2_, p_149749_3_, p_149749_4_);

            if (tileentitybrickovenidle != null)
            {
                for (int i1 = 0; i1 < tileentitybrickovenidle.getSizeInventory(); ++i1)
                {
                    ItemStack itemstack = tileentitybrickovenidle.getStackInSlot(i1);
