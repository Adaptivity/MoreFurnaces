...
public class ContainerObsidianOven extends Container
{
    private TileEntityObsidianOven tileFurnace;
    private int lastCookTime;
    private int lastBurnTime;
    private int lastItemBurnTime;
    private static final String __OBFID = "CL_00001748";

    public ContainerObsidianOven(InventoryPlayer par1InventoryPlayer, TileEntityObsidianOven par2TileEntityObsidianOven)
    {
        this.tileFurnace = par2TileEntityObsidianOven;
        this.addSlotToContainer(new Slot(par2TileEntityObsidianOven, 0, 56, 17));
        this.addSlotToContainer(new Slot(par2TileEntityObsidianOven, 1, 56, 53));
        this.addSlotToContainer(new SlotObsidianOven(par1InventoryPlayer.player, par2TileEntityObsidianOven, 2, 116, 35));
        int i;
    ...
    public ItemStack transferStackInSlot(EntityPlayer par1EntityPlayer, int par2)
    {
        ...
        if (slot != null && slot.getHasStack())
        {
            ...
            {
                if (ObsidianOvenRecipes.smelting().getSmeltingResult(itemstack1) != null)
                {
                ...
                else if (TileEntityObsidianOven.isItemFuel(itemstack1))
                {
