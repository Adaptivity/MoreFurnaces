...
public class TileEntityObsidianOven extends TileEntity implements ISidedInventory
{
    ...
    public void updateEntity()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            {
                flag1 = true;
                ObsidianOven.updateFurnaceBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
            }
        }
    ...
    private boolean canSmelt()
    {
        ...
        {
            ItemStack itemstack = ObsidianOvenRecipes.smelting().getSmeltingResult(this.furnaceItemStacks[0]);
    ...
    public static int getItemBurnTime(ItemStack p_145952_0_)
    {
        ...
        else
        {
            ...
            if (item instanceof ItemSword && ((ItemSword)item).getToolMaterialName().equals("WOOD")) return 300;
            if (item instanceof ItemHoe && ((ItemHoe)item).getToolMaterialName().equals("WOOD")) return 300;
            if (item == Items.stick) return 200;
            if (item == Items.coal) return 1700;
            if (item == Items.lava_bucket) return 20100;
