package com.jumpyblock.morefurnaces.furnaces.obsidianfurnace;
...
public class ObsidianOven extends BlockContainer
{
    ...
    public ObsidianOven(boolean p_i45407_1_)
    {
        super(Material.rock);
    ...
    {
        return Item.getItemFromBlock(MoreFurnaces.obsidianOven);
    }
    ...
    public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9)
    {
    	...
    	{
    		TileEntityObsidianOven var10 = (TileEntityObsidianOven) par1World.getTileEntity(par2, par3, par4);
    		if (var10 != null)
    		{
    			par5EntityPlayer.openGui(MoreFurnaces.instance, 5, par1World, par2, par3, par4);
    		}
    		return true;
    	}
    	else
    ...
    public static void updateFurnaceBlockState(boolean p_149931_0_, World p_149931_1_, int p_149931_2_, int p_149931_3_, int p_149931_4_)
    {
        ...
        if (p_149931_0_)
        {
            p_149931_1_.setBlock(p_149931_2_, p_149931_3_, p_149931_4_, MoreFurnaces.obsidianOvenActive);
        }
        else
        {
            p_149931_1_.setBlock(p_149931_2_, p_149931_3_, p_149931_4_, MoreFurnaces.obsidianOven);
        }
    ...
    {
        return new TileEntityObsidianOven();
    }
    ...
    public void onBlockPlacedBy(World p_149689_1_, int p_149689_2_, int p_149689_3_, int p_149689_4_, EntityLivingBase p_149689_5_, ItemStack p_149689_6_)
    {
        ...
        {
            ((TileEntityObsidianOven)p_149689_1_.getTileEntity(p_149689_2_, p_149689_3_, p_149689_4_)).func_145951_a(p_149689_6_.getDisplayName());
        }
    }
    ...
    public void breakBlock(World p_149749_1_, int p_149749_2_, int p_149749_3_, int p_149749_4_, Block p_149749_5_, int p_149749_6_)
    {
        if (!field_149934_M)
        {
            TileEntityObsidianOven tileentityobsidianovenidle = (TileEntityObsidianOven)p_149749_1_.getTileEntity(p_149749_2_, p_149749_3_, p_149749_4_);

            if (tileentityobsidianovenidle != null)
            {
                for (int i1 = 0; i1 < tileentityobsidianovenidle.getSizeInventory(); ++i1)
                {
                    ItemStack itemstack = tileentityobsidianovenidle.getStackInSlot(i1);
