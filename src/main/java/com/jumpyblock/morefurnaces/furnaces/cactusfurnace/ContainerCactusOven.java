...
public class ContainerCactusOven extends Container
{
    private TileEntityCactusOven tileFurnace;
    private int lastCookTime;
    private int lastBurnTime;
    private int lastItemBurnTime;
    private static final String __OBFID = "CL_00001748";

    public ContainerCactusOven(InventoryPlayer par1InventoryPlayer, TileEntityCactusOven par2TileEntityCactusOven)
    {
        this.tileFurnace = par2TileEntityCactusOven;
        this.addSlotToContainer(new Slot(par2TileEntityCactusOven, 0, 56, 17));
        this.addSlotToContainer(new Slot(par2TileEntityCactusOven, 1, 56, 53));
        this.addSlotToContainer(new SlotCactusOven(par1InventoryPlayer.player, par2TileEntityCactusOven, 2, 116, 35));
        int i;
    ...
    public ItemStack transferStackInSlot(EntityPlayer par1EntityPlayer, int par2)
    {
        ...
        if (slot != null && slot.getHasStack())
        {
            ...
            {
                if (CactusOvenRecipes.smelting().getSmeltingResult(itemstack1) != null)
                {
                ...
                else if (TileEntityCactusOven.isItemFuel(itemstack1))
                {
