...
public class ContainerQuartzOven extends Container
{
    private TileEntityQuartzOven tileFurnace;
    private int lastCookTime;
    private int lastBurnTime;
    private int lastItemBurnTime;
    private static final String __OBFID = "CL_00001748";

    public ContainerQuartzOven(InventoryPlayer par1InventoryPlayer, TileEntityQuartzOven par2TileEntityQuartzOven)
    {
        this.tileFurnace = par2TileEntityQuartzOven;
        this.addSlotToContainer(new Slot(par2TileEntityQuartzOven, 0, 56, 17));
        this.addSlotToContainer(new Slot(par2TileEntityQuartzOven, 1, 56, 53));
        this.addSlotToContainer(new SlotQuartzOven(par1InventoryPlayer.player, par2TileEntityQuartzOven, 2, 116, 35));
        int i;
    ...
    public ItemStack transferStackInSlot(EntityPlayer par1EntityPlayer, int par2)
    {
        ...
        if (slot != null && slot.getHasStack())
        {
            ...
            {
                if (QuartzOvenRecipes.smelting().getSmeltingResult(itemstack1) != null)
                {
                ...
                else if (TileEntityQuartzOven.isItemFuel(itemstack1))
                {
